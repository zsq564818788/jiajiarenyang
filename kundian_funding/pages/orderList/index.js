...
Page({
    ...
    getOrderData: function(t, r, n) {
        var d = this, o = wx.getStorageSync("uid_" + a);
        wx.request({
            url: e,
            data: {
                op: "getOrderData",
            ...
            success: function(t) {
                if (t.data.orderData) {
                    var a = [];
                    1 == n ? (a = d.data.orderData, t.data.orderData.map(function(t) {
                        a.push(t);
                    })) : (a = t.data.orderData, r = 1), d.setData({
                        orderData: a,
                        page: r
                    });
                }
    ...
    payOrder: function(r) {
        var n = r.currentTarget.dataset.orderid, d = wx.getStorageSync("uid_" + a);
        t.util.request({
