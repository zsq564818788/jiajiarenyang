...
Page({
    ...
    subOrder: function(n) {
        var r = this, i = wx.getStorageSync("uid_" + t), c = r.data, s = c.count, o = c.proDetail, d = c.spec, u = c.name, p = c.phone, l = c.address, f = c.total_price, g = c.remark, _ = c.return_type;
