...
Page({
    ...
    onLoad: function(t) {
        var a = this, i = t.goods_id, n = wx.getStorageSync("uid_" + s), d = t.user_uid;
    ...
    onShow: function(t) {
        var a = this, e = a.data.user_uid, i = wx.getStorageSync("uid_" + s);
        void 0 != e && 0 != e && (o.loginBindParent(e, i), a.setData({
            user_uid: e
        }));
    },
    showMode: function() {
    ...
    buyNow: function(t) {
        var a = this, e = wx.getStorageSync("uid_" + s);
        if (0 != e && void 0 != e) {
            var o = a.data, i = o.goodsData, n = o.count;
            1 == i.is_open_sku ? a.setData({
                state: !0
            }) : i.count >= 1 && n > i.count ? wx.navigateTo({
                url: "../confrimOrder/index?goods_id=" + i.id + "&count=" + n
            }) : wx.showToast({
                title: "库存不足"
            });
        } else wx.navigateTo({
    ...
    sureGoods: function(t) {
        var a = this.data, e = a.goods_id, o = a.goodsData, i = (a.specItem, a.count), n = a.specVal, d = wx.getStorageSync("uid_" + s);
        if (0 == d || void 0 == d) wx.navigateTo({
            url: "../../../login/index"
        }); else if (1 == o.is_open_sku) {
            if (0 == n.length || "" == n) return wx.showToast({
                title: "请选择规格"
            }), !1;
            if (n.count >= 1) return n.count >= i ? void wx.navigateTo({
                url: "../confrimOrder/index?goods_id=" + e + "&spec_id=" + n.id + "&count=" + i
            }) : void wx.showToast({
                title: "库存不足"
            });
            wx.showToast({
            ...
            if (n.count >= 1) return n.count >= i ? void wx.navigateTo({
                url: "../confrimOrder/index?goods_id=" + e + "&count=" + i
            }) : void wx.showToast({
                title: "库存不足"
            });
            wx.showToast({
    ...
    onShareAppMessage: function() {
        var t = this.data.goodsData, a = wx.getStorageSync("uid_" + s);
        return {
