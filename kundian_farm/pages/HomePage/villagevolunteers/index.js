...
Page({
    ...
    subOrder: function(a){
        ...
        wx.navigateTo({
            ...
            // confrimOrder/index?goodsid=" + a + "&spec_id=" + i + "&count=" + n
            url: "/kundian_farm/pages/shop/confrimOrder/index?goodsid=" + t + "&spec_id=" + i + "&count=" + n
        });
            // url: "/kundian_farm/pages/shop/confrimOrder/index.html "
            // url: "/kundian_farm/pages/shop/prodeteils/index.html?goodsid=56"
        // var IS = this.data.iszhiyuanzhe;
        // var o = this;
        // var goods = {id:"56",}
        // var g = 1, n= "广东省 广州市 海珠区 新港中路397号", d = "张三", c = "020-81167888", a = "2", m = undefined, x = undefined, s = 18, i= "", v= undefined, f=0, y= 0, p = 0, l = 0.01, 
        // h= 0, t1 = "the formId is no longer available in develop or trial version of this mini program", _ = 1;
        // console.log(e)
        // if(IS == 0){
        //   var  P = {
        //         control: "shop",
