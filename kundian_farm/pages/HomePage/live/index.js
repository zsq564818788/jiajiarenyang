...
Page({
    ...
    onLoad: function(t) {
        var e = this, i = t.user_uid, n = wx.getStorageSync("uid_" + s);
    ...
    onShareAppMessage: function() {
        var a = wx.getStorageSync("uid_" + t), e = "/kundian_farm/pages/HomePage/live/index";
        return a && (e = "/kundian_farm/pages/HomePage/live/index?user_uid=" + a), {
            path: e,
            success: function(a) {},
            title: "实时监控"
        };
