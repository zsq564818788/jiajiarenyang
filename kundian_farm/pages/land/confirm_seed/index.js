...
Page({
    ...
    surePay: function(e) {
        var o = this, i = e.detail.formId, n = o.data.seed, c = o.data.totalPrice, d = o.data, r = d.lid, s = d.userCoupon, u = 0, l = 0;
        "" != s && (u = s.coupon.id, l = s.coupon.coupon_price);
        var p = wx.getStorageSync("uid_" + t);
        if (0 != p) {
            var g = o.data.order_id;
            a.util.request({
                ...
                method: "POST",
                success: function(e) {
                    g = e.data.order_id, a.util.request({
                        url: "entry/wxapp/pay",
                        data: {
                            op: "getSeedPayOrder",
                            control: "land",
