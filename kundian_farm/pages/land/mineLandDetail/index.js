...
Page({
    ...
    onLoad: function(e) {
        var n = this, i = e.lid, d = wx.getStorageSync("uid_" + t), o = wx.getStorageSync("kundian_farm_setData");
        wx.showLoading({
            title: "玩命加载中..."
        }), a.util.request({
    ...
    getLandDetail: function(e) {
        var n = this, i = wx.getStorageSync("uid_" + t);
        a.util.request({
            url: "entry/wxapp/class",
            data: {
                op: "getMineLandDetail",
    ...
    watering: function(e) {
        var n = this, i = n.data, d = i.mineLand, o = i.open_land_pay, s = wx.getStorageSync("uid_" + t), c = e.detail.formId;
    ...
    weeding: function(e) {
        var n = this.data, i = n.mineLand, d = n.open_land_pay, o = wx.getStorageSync("uid_" + t), s = e.detail.formId;
    ...
    closeDevice: function(e, n) {
        var i = this, d = wx.getStorageSync("uid_" + t);
        a.util.request({
            url: "entry/wxapp/class",
            data: {
                op: "closeDevice",
    ...
    lookStatusInfo: function(e) {
        if (this.setData({
            ...
            var n = this, i = e.currentTarget.dataset.seedid, d = e.currentTarget.dataset.lid, o = e.detail.formId, s = wx.getStorageSync("uid_" + t);
            wx.showLoading({
                title: "玩命加载中..."
            }), a.util.request({
                url: "entry/wxapp/class",
