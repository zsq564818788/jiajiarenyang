...
var t = new getApp(), e = {
    ...
    handleCalendar: function(a) {
        ...
        var i = wx.getStorageSync("uid_" + l), l = t.siteInfo.uniacid, o = this, u = o.data.calendar;
        t.util.request({
    ...
    tapDayItem: function(a) {
        ...
        if ((d = new Date(d)).getTime() - s.getTime() == 0) {
            ...
            var c = this.data.calendar.curYear, i = this.data.calendar.curMonth, l = n[r].day, o = wx.getStorageSync("uid_" + u), u = t.siteInfo.uniacid, h = this;
            t.util.request({
                url: "entry/wxapp/class",
                data: {
                    control: "sign",
