...
Page({
    ...
    onLoad: function(n) {
        var a = wx.getStorageSync("uid_" + t), o = this;
        e.util.request({
    ...
    getPhoneNumber: function(n) {
        if ("getPhoneNumber:fail user deny" != n.detail.errMsg) {
            var a = this, o = wx.getStorageSync("uid_" + t), i = a.data, s = i.code, c = i.userInfo;
            s ? e.util.request({
                url: "entry/wxapp/class",
                data: {
    ...
    savePhone: function(n) {
        var a = this, o = a.data, i = o.msgCode, s = o.hand_phone, c = o.userInfo, d = n.detail.value.code, r = n.detail.formId, u = wx.getStorageSync("uid_" + t);
