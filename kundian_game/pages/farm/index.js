...
Page({
    ...
    onLoad: function(t) {
        var e = this, i = wx.getStorageSync("uid_" + n);
        ...
        wx.getStorageSync("enter_is_play") && wx.removeStorageSync("enter_is_play"), this.getSet();
    },
    ...
    onShow: function() {
        var t = wx.getStorageSync("uid_" + n), a = this.data.share_uid;
        ...
        a.util.request({
            ...
            success: function(a) {
                wx.request({
                    ...
                    success: function(t) {
                        if (41009 == t.data.errno) return e.setData({
                            is_auth: !1
                        }), !1;
                        var a = t.data, n = a.lands, i = a.userData;
                        e.setData({
                            lands: n,
                            userData: i
                        }), e.getStatusIndex();
    ...
    WillClose: function() {
        var t = this, a = wx.getStorageSync("uid_" + n), e = wx.getStorageSync("kundianPlaySet"), s = t.data.userData;
        wx.request({
            url: i,
            data: {
                op: "getCoin",
    ...
    checkFriend: function() {
        ...
        if (this.setData({
            ...
            var a = this, e = wx.getStorageSync("uid_" + n);
            wx.request({
                url: i,
                data: {
                    op: "getFriendInfo",
    ...
    mature: function(t) {
        var a = t.currentTarget.dataset.id, e = this.data.lands, s = e.findIndex(function(t) {
            return t.id == a;
        }), o = this, r = t.currentTarget.dataset.minelandid, d = wx.getStorageSync("uid_" + n);
        wx.request({
            url: i,
            data: {
                op: "pickSeed",
    ...
    payfor: function(t) {
        var e = this, i = e.data.totalPrice, s = t.currentTarget.dataset.landid, o = wx.getStorageSync("uid_" + n), r = this.data.seedsList.filter(function(t) {
            return t.num > 0;
        });
    ...
    onShareAppMessage: function(t) {
        t.from;
        var a = wx.getStorageSync("uid_" + n);
        return {
    ...
    intoLandDetail: function(t) {
        var a = this.data.currentLand;
        3 == a.order_type && wx.navigateTo({
            url: "/kundian_farm/pages/land/order/detail?order_id=" + a.id
        }), 4 == a.order_type && wx.navigateTo({
            url: "/kundian_farm/pages/land/order/seed?order_id=" + a.id
        });
    },
    intoLive: function(t) {
        wx.navigateTo({
    ...
    updateUserInfo: function(t) {
        ...
        e.util.getUserInfo(function(t) {
            wx.setStorageSync("uid_" + n, t.memberInfo.uid), wx.setStorageSync("kundian_farm_userInfo", t.memberInfo), 
    ...
    operationLand: function(t) {
        var e = this, i = t.currentTarget.dataset, s = i.orderid, o = i.operatype, r = i.landname, d = i.did, u = i.num, c = wx.getStorageSync("uid_" + n);
        if (1 == this.data.kundianPlaySet.open_land_pay) {
            wx.showLoading({
                title: "加载中..."
            });
            var l = 1;
            return "shifei" == o && (l = 1), "jiaoshui" == o && (l = 4), "shachong" == o && (l = 3), 
            "chucao" == o && (l = 2), void a.util.request({
                url: "entry/wxapp/class",
                data: {
                    op: "operationNewLand",
                    control: "control",
    ...
    closeDevice: function(t, e) {
        var i = this, s = wx.getStorageSync("uid_" + n);
        a.util.request({
            url: "entry/wxapp/class",
            data: {
                op: "closeNewDid",
    ...
    onUnload: function(t) {
        var a = this.data, e = a.close_type, n = a.currentDid;
        this.closeDevice(n, e), clearInterval(this.data.timer);
    },
    ...
    getSeedBagData: function(t) {
        var e = this, i = wx.getStorageSync("uid_" + n), s = a.util.getNewUrl("entry/wxapp/game", "kundian_farm_plugin_play");
        wx.request({
            url: s,
            data: {
                op: "getSeedBagData",
