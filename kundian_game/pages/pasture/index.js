...
Page({
    ...
    getMyAnimal: function(e) {
        var n = this, i = !1, s = a.util.getNewUrl("entry/wxapp/game", "kundian_farm_plugin_play"), o = wx.getStorageSync("uid_" + t);
        wx.request({
            url: s,
            data: {
                op: "getMyAnimal",
    ...
    checkFriend: function() {
        ...
        var n = this, i = wx.getStorageSync("uid_" + t), s = a.util.getNewUrl("entry/wxapp/game", "kundian_farm_plugin_play");
        wx.request({
            url: s,
            data: {
                op: "getFriendInfo",
    ...
    saleItem: function() {
        var e = this, n = e.data.currentAnimal, i = wx.getStorageSync("uid_" + t);
        ...
        wx.showModal({
            ...
            success: function(s) {
                if (s.confirm) {
                    var o = a.util.getNewUrl("entry/wxapp/game", "kundian_farm_plugin_play");
                    wx.request({
                        url: o,
                        data: {
                            op: "saleAdopt",
    ...
    updates: function() {
        var e = this, n = wx.getStorageSync("uid_" + t);
